export default {
  ...
  // AR Learning Page
  'ar.title': 'AR Learning',
  'ar.availableLessons': 'Available AR Lessons',
  'ar.exitAR': 'Exit AR',
  'ar.cameraOff': 'Camera Off',
  'ar.turnOnCamera': 'Turn on camera to see AR instructor',
  'ar.virtualInstructor': 'Virtual Instructor',
  'ar.selectCamera': 'Select camera',
  'ar.sign': 'Sign',
  'ar.of': 'of',
  'ar.previous': 'Previous',
  'ar.next': 'Next',
  'ar.lesson.basicGreetings': 'Basic Greetings',
  'ar.lesson.basicGreetings.duration': '5 min',
  'ar.lesson.basicGreetings.difficulty': 'Beginner',
  'ar.lesson.introductionPhrases': 'Introduction Phrases',
  'ar.lesson.introductionPhrases.duration': '7 min',
  'ar.lesson.introductionPhrases.difficulty': 'Beginner',
  'ar.lesson.workplaceBasics': 'Workplace Basics',
  'ar.lesson.workplaceBasics.duration': '10 min',
  'ar.lesson.workplaceBasics.difficulty': 'Intermediate',
  'ar.difficulty.beginner': 'Beginner',
  'ar.difficulty.intermediate': 'Intermediate',
  'ar.difficulty.advanced': 'Advanced',
};
